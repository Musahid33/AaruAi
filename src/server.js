...
/* ------------------------- provider catalog ------------------------- */
const CATALOG = [
  { id: 'kilo', label: 'Kilo Code (FREE — no key)', baseURL: 'https://api.kilo.ai/api/gateway/v1', defaultModel: 'minimax/minimax-m3:free', keyURL: '', envKey: '', local: true, note: 'Free open gateway routing OpenRouter free tier: MiniMax M3 (1M ctx), Step 3.7 Flash, Laguna S, Ling 3.0 Flash, Dots 3. No key, no signup. ~free req/hr; rate limits under load.', models: ['minimax/minimax-m3:free', 'stepfun/step-3.7-flash:free', 'poolside/laguna-s-2.1:free', 'inclusionai/ling-3.0-flash-fin:free', 'inclusionai/ling-3.0-flash-sante:free', 'dots-studio/dots-3-note-preview:free', 'kilo-auto/free'] },
  { id: 'ollamacloud', label: 'Ollama Cloud (free tier)', baseURL: 'https://api.ollama.com/v1', defaultModel: 'minimax-m3', keyURL: 'https://ollama.com/settings/keys', envKey: 'OLLAMA_KEY', note: 'Free cloud models: MiniMax M3 (1M ctx), Kimi K3/K2.6, GLM-5.3/5.2, DeepSeek V4, Nemotron, GPT-OSS. Free key from ollama.com signup (no card); session/weekly limits.', models: ['minimax-m3', 'kimi-k3', 'kimi-k2.6', 'glm-5.3-flash', 'glm-5.2', 'glm-5.1', 'deepseek-v4-flash:0731', 'deepseek-v4-pro:0813', 'nemotron-3-super', 'nemotron-3-ultra', 'nemotron-3-nano:30b', 'gpt-oss:20b', 'gpt-oss:120b', 'gemma4:31b', 'qwen3.5:397b', 'kimi-k2.7-code', 'mistral-large-3:675b', 'minimax-m2.7'] },
  ...
  { id: 'gemini', label: 'Google Gemini', baseURL: 'https://generativelanguage.googleapis.com/v1beta/openai', defaultModel: 'gemini-3.6-flash', keyURL: 'https://aistudio.google.com/apikey', envKey: 'GEMINI_API_KEY', models: ['gemini-3.8-flash', 'gemini-3.7-flash', 'gemini-3.6-flash', 'gemini-3.1-flash-lite', 'gemini-2.5-flash-lite', 'gemini-2.5-pro'] },
