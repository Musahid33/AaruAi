...
const CATALOG = [
  ...
  { id: 'nvidia', label: 'NVIDIA NIM (free — 81 models)', baseURL: 'https://integrate.api.nvidia.com/v1', defaultModel: 'moonshotai/kimi-k3', keyURL: 'https://build.nvidia.com/settings/api-keys', envKey: 'NVIDIA_API_KEY', models: ['moonshotai/kimi-k3', 'minimaxai/minimax-m3', 'nvidia/nemotron-3-ultra-550b-a55b', 'mistralai/mistral-nemotron', 'poolside/laguna-xs-2.1', 'openai/gpt-oss-20b', 'nvidia/nemotron-3-nano-omni-30b-a3b-reasoning'] },
